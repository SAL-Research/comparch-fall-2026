...
module.exports = {
  ...
  homeworks: [
    { key: 'hw1', id: 'HW 1', topic: 'In-Order Pipeline', assigned: 'Sep 24', deadline: 'Oct 18', handout: 'TBA', repo: 'TBA', submission: 'https://moodle.bilkent.edu.tr/current/mod/assign/view.php?id=21222&forceview=1' },
